...
import { ShipmentCalcPipe } from './pages/page-cart/pipes/shipment-calc.pipe';
import { OrderShipmentStatusComponent } from './pages/page-track-order/order-shipment-status/order-shipment-status.component';
import { TotalSumPipe } from './pages/page-checkout/total-sum.pipe';
