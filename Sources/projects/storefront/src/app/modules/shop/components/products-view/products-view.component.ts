import { Component, EventEmitter, HostBinding, Input, OnChanges, OnDestroy, OnInit, Output, ViewChild } from '@angular/core';
...
export class ProductsViewComponent implements OnInit, OnDestroy , OnChanges {

    @Input() FilteredProducts : any;

    @Output() NewChangeSorting: EventEmitter<string> = new EventEmitter<string>()

    b3ayneJannMnWaraElSort: string = "default"

    NewFilteredProducts : any[] = []
    ...
    ngOnInit(): void {
        ...
        this.sortControl.valueChanges.subscribe(d =>{
            this.page.isLoading = true
            this.NewChangeSorting.emit(d)
        })
