...
import { StationCardComponent } from './pages/station-card/station-card.component';
import { StationReservationComponent } from './pages/station-reservation/station-reservation.component';
